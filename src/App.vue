...
<style>
  ...
  * {
  ...
  .cssTable caption button {
    float: right;
    margin-top: 6px;
  }
  .cssTable caption input {
    margin-left: 50px;
  }
  .cssTable th {
  ...
  /* Buttons ###################################### */
  .cssButDef, .cssButOK, .cssButDanger, .cssButWarn {
    font-size: 16px;
    color: #fff;
    border-radius: 4px;
    cursor: pointer;
